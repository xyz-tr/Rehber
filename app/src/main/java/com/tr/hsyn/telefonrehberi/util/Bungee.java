...
public class Bungee{
   ...
   public static void zoomFast(Context context){
      ...
      ((Activity) context).overridePendingTransition(R.anim.zoom_enter_fast, R.anim.zoom_exit_fast);
   }
   ...
   public static void fadeFast(Context context){
      ...
      ((Activity) context).overridePendingTransition(R.anim.fade_enter_fast, R.anim.fade_exit_fast);
   }
