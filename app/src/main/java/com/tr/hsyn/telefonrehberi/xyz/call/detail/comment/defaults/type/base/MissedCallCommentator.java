...
/**
 * <h1>MissedCallCommentator</h1>
 * 
 * <p>
 *    Cevapsız aramalar için yorumcu.
 * 
 * @author hsyn 2019-12-02 14:59:14
 */
public abstract class MissedCallCommentator 
      extends Commentator
      implements RingingCommentator, CountCommentator, FrequencyCommentator, RelationCommentator, TimeTableCommentator{
   
   protected MissedCallCommentator(WeakReference<Activity> activityWeakReference, IComment commentStore){
